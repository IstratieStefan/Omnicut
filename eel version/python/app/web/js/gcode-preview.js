    ...
    ***************************************************************************** */
    ...
    class WebGLPreview {
        ...
        render() {
            ...
            for (let index = 0; index < this.layers.length; index++) {
                ...
                if (this.renderExtrusion) {
                    ...
                    const extrusionColor = new three.Color(`rgb(${Math.round(this.startColor[0]+(this.stopColor[0]-this.startColor[0])*brightness/100)}, ${Math.round(this.startColor[1]+(this.stopColor[1]-this.startColor[1])*brightness/100)}, ${Math.round(this.startColor[2]+(this.stopColor[2]-this.startColor[2])*brightness/100)})`).getHex();
        ...
        addArcSegment(layer, p1, p2, extrude, cw) {
            ...
            console.log('totalSegments', totalSegments, 'inches', this.inches);
